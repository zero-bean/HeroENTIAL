...
void Stage1::LoadMonster()
{
	...
	ResourceManager::GET_SINGLE()->LoadTexture(L"Goblin_Warrior_Right", L"Sprite/Monster/Goblin/Goblin_Right.bmp");
	ResourceManager::GET_SINGLE()->LoadTexture(L"Goblin_Warrior_Left", L"Sprite/Monster/Goblin/Goblin_Left.bmp");
